...
"All Regions",
 ...
 exit={{ opacity: 0 }}
 onClick={onClose}
 className="fixed inset-0 z-50 bg-card/10 dark:bg-black/40 backdrop-blur-[2px]"
 />
 ...
 className="w-full max-w-[400px] bg-card rounded-[2rem] shadow-2xl shadow-slate-200/50 dark:shadow-black/50 flex flex-col max-h-[500px] overflow-hidden pointer-events-auto border border-border"
 >
 {/* Header - Compact and modern */}
 <div className="px-6 pt-6 pb-4 flex items-center justify-between shrink-0">
 <h2 className="text-xl font-black text-foreground tracking-tight">Filter Region</h2>
 <button 
 onClick={onClose}
 className="p-2 rounded-xl text-muted-foreground hover:bg-muted dark:hover:bg-muted hover:text-foreground dark:hover:text-slate-100 transition-all"
 >
 <X size={18} />
 </button>
 </div>
 ...
 <input 
 className="w-full bg-muted border border-border rounded-xl pl-11 pr-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:ring-4 focus:ring-primary/10 transition-all outline-none"
...
"text-sm font-bold tracking-tight",
 ...
 <p className="text-sm font-medium text-muted-foreground">No regions found matching"{searchQuery}"</p>
 </div>
 )}
 </div>
 </div>
