...
export function PwaUpdater() {
 ...
 className="fixed bottom-6 right-6 left-6 md:left-auto z-[9999] bg-card border border-border rounded-2xl shadow-2xl p-4 flex flex-col gap-3 md:w-80"
 >
 <div className="flex items-start justify-between gap-4">
 <div>
 <h4 className="text-foreground font-black text-sm">Versi Baru Tersedia!</h4>
 <p className="text-muted-foreground text-xs mt-1 leading-relaxed font-medium">
 Pembaruan aplikasi telah diunduh. Muat ulang sekarang untuk menggunakan fitur terbaru.
 </p>
 </div>
 <button 
 onClick={() => setShowReload(false)} 
 className="text-muted-foreground hover:text-muted-foreground dark:hover:text-slate-200 p-1 bg-muted rounded-lg transition-colors shrink-0"
