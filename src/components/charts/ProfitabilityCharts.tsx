...
export const WaterfallChart = memo(function WaterfallChart({ data }: WaterfallChartProps) {
 ...
 <div className="bg-card text-white px-4 py-2.5 rounded-2xl text-xs font-bold shadow-2xl border border-white/10 backdrop-blur-md">
...
export const ServiceMixChart = memo(function ServiceMixChart({ data, totalActiveUsers }: ServiceMixChartProps) {
 ...
 <span 
 className={`text-4xl font-black leading-none transition-colors duration-300 ${hoveredSlice ?'':'text-foreground'}`}
