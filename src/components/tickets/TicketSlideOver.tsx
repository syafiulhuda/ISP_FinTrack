...
export function TicketSlideOver({ isOpen, onClose, customerId }: TicketSlideOverProps) {
 ...
 exit={{ opacity: 0 }}
 onClick={onClose}
 className="fixed inset-0 z-[200] bg-card/40 backdrop-blur-sm"
 />
 ...
 <label className="text-[11px] font-black uppercase tracking-widest text-muted-foreground">Issue Category</label>
 <select
 name="issue_category"
 ...
 <label className="text-[11px] font-black uppercase tracking-widest text-muted-foreground">Priority Level</label>
...
"cursor-pointer p-4 rounded-2xl border-2 transition-all",
 ...
 >
 <AlertCircle size={20} className={formData.priority ==="CRITICAL"?"text-rose-500":"text-muted-foreground"} />
 <p className={cn("font-black mt-2 text-sm", formData.priority ==="CRITICAL"?"text-rose-700 dark:text-rose-400":"text-muted-foreground")}>Critical</p>
 <p className="text-[10px] text-muted-foreground font-medium mt-1">SLA: 2 Hours</p>
 </div>
...
"cursor-pointer p-4 rounded-2xl border-2 transition-all",
 ...
 >
 <Clock size={20} className={formData.priority ==="HIGH"?"text-amber-500":"text-muted-foreground"} />
 <p className={cn("font-black mt-2 text-sm", formData.priority ==="HIGH"?"text-amber-700 dark:text-amber-400":"text-muted-foreground")}>High</p>
 <p className="text-[10px] text-muted-foreground font-medium mt-1">SLA: 4 Hours</p>
 </div>
...
"cursor-pointer p-4 rounded-2xl border-2 transition-all",
 ...
 >
 <Clock size={20} className={formData.priority ==="LOW"?"text-muted-foreground":"text-muted-foreground"} />
 <p className={cn("font-black mt-2 text-sm", formData.priority ==="LOW"?"text-foreground":"text-muted-foreground")}>Low</p>
 <p className="text-[10px] text-muted-foreground font-medium mt-1">SLA: 48 Hours</p>
 </div>
 </div>
 </div>
 ...
 {/* Description */}
 <div className="space-y-2">
 <label className="text-[11px] font-black uppercase tracking-widest text-muted-foreground">Problem Description</label>
 <textarea
 name="description"
