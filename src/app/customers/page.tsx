...
export default function CustomerAnalysisPage() {
 ...
 <div key={i} className="h-[200px] bg-muted animate-pulse rounded-[2.5rem] border border-border"/>
 ))
 ) : (
 <>
 <m.div
 ...
 <div key={i} className="h-16 bg-muted animate-pulse rounded-2xl w-full"/>
 ))}
 </div>
