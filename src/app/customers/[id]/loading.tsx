...
export default function CustomerLoading() {
 ...
 <div className="p-3 bg-muted rounded-2xl border border-border w-11 h-11 shrink-0"/>
 ...
 <div className="h-12 bg-muted rounded-2xl w-full tablet:w-40"/>
 <div className="h-12 bg-muted rounded-2xl w-full tablet:w-40"/>
 </div>
 </div>
 ...
 <div className="w-32 h-32 rounded-full border-8 border-border"/>
