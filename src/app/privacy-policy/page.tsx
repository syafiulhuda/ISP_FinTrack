      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-8 sm:p-12">
          ...
          <div className="space-y-8 text-slate-600 dark:text-slate-300 leading-relaxed">
            <section>
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">1. Pendahuluan</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">2. Data yang Kami Kumpulkan</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">3. Tujuan Penggunaan Data</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">4. Pengungkapan kepada Pihak Ketiga</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">5. Keamanan Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">6. Hak Pengguna (Sesuai UU PDP)</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">7. Hubungi Kami</h2>
              <p>
