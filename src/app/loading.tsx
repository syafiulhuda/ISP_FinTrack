...
export default function DashboardLoading() {
 ...
 <div className="w-10 h-10 md:w-12 md:h-12 bg-muted animate-pulse rounded-xl"/>
 </div>
 </div>
 ...
 <div
 key={i}
 className="h-[140px] bg-muted animate-pulse rounded-3xl"
 />
 ))}
 </div>
 ...
 <div className="h-7 w-44 bg-muted animate-pulse rounded-xl"/>
 ...
 {/* CTA Card */}
 <div className="bg-muted rounded-3xl p-8 h-[160px] animate-pulse"/>
 </div>
 </div>
 </div>
 );
