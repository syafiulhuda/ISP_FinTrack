...
export default function LogoutPage() {
 ...
 />
 <div className="relative w-24 h-24 bg-card rounded-3xl shadow-2xl border border-border flex items-center justify-center mx-auto mb-8">
 <LogOut size={40} className="text-primary"/>
 </div>
 </div>

 <div className="space-y-4">
 <h1 className="text-3xl font-black text-foreground tracking-tight">Signing out...</h1>
 ...
 className="w-48 h-1.5 bg-muted rounded-full overflow-hidden relative"
 >
 ...
 <span className="text-lg font-black text-muted-foreground tracking-tight">ISP-FinTrack</span>
 </div>
 </div>
 );
}
