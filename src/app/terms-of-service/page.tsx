...
export default function TermsOfServicePage() {
 ...
 <section>
 <h2 className="text-xl font-semibold text-foreground mb-4">1. Penerimaan Ketentuan</h2>
 <p>
 ...
 <section>
 <h2 className="text-xl font-semibold text-foreground mb-4">2. Deskripsi Layanan</h2>
 <p>
 ...
 <section>
 <h2 className="text-xl font-semibold text-foreground mb-4">3. Akun dan Keamanan Pengguna</h2>
 ...
 <section>
 <h2 className="text-xl font-semibold text-foreground mb-4">4. Batasan Tanggung Jawab (SLA)</h2>
 <p>
 ...
 <section>
 <h2 className="text-xl font-semibold text-foreground mb-4">5. Pengelolaan Data Finansial</h2>
 <p>
 ...
 <section>
 <h2 className="text-xl font-semibold text-foreground mb-4">6. Pemutusan Akses</h2>
 <p>
 ...
 <section>
 <h2 className="text-xl font-semibold text-foreground mb-4">7. Perubahan Ketentuan</h2>
 <p>
