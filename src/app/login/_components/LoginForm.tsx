...
export function LoginForm() {
 ...
 <label htmlFor="email"className="text-sm font-black text-foreground uppercase tracking-wider text-[11px]">Work Email</label>
 ...
 <div className="space-y-2">
 <label htmlFor="otp"className="text-sm font-black text-foreground uppercase tracking-wider text-[11px]">Verification Code</label>
 <div className="relative group">
 ...
 <>
 <div className="space-y-2">
 <label className="text-sm font-black text-foreground uppercase tracking-wider text-[11px]">Identitas Anda (Role)</label>
 <div className="relative group">
 <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-primary transition-colors"size={20} />
 <select 
 value={requesterRole}
 ...
 <div className="space-y-2">
 <label className="text-sm font-black text-foreground uppercase tracking-wider text-[11px]">User yang Ingin Direset</label>
 <div className="relative group">
 <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-primary transition-colors"size={20} />
 <select 
 value={targetUserId}
 ...
 >
 <label htmlFor="requesterPassword"className="text-sm font-black text-foreground uppercase tracking-wider text-[11px]">
 ...
 <label htmlFor="password"className="text-sm font-black text-foreground uppercase tracking-wider text-[11px]">Password</label>
 <button 
 type="button"
 onClick={() => { 
 ...
 className="text-xs font-bold text-muted-foreground hover:text-primary hover:underline transition-colors"
 >
 Forgot password?
 </button>
 </div>
