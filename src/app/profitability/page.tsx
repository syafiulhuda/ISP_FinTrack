...
const CustomTooltip = ({ active, payload }: { active?: boolean; payload?: any[] }) => {
 ...
 return (
 <div className="bg-white px-3 py-2 rounded-xl shadow-xl border border-border">
...
export default function ProfitabilityPage() {
 ...
 <div>
 <h1 className="text-xl md:text-2xl lg:text-3xl font-black text-foreground tracking-tight">Profitability Analysis</h1>
 <p className="text-xs md:text-sm font-medium text-muted-foreground mt-1">Segmented performance and unit economics audit.</p>
 </div>
...
"text-[8px] sm:text-[10px] font-black px-2 sm:px-3 py-1 rounded-full uppercase tracking-wider transition-colors",
 ...
 <div key={i} className="h-[165px] lg-phone:h-[170px] tablet:h-[160px] lg:h-[200px] bg-muted animate-pulse rounded-3xl border border-border"/>
 ))
 ) : (
 dynamicData.metrics.map((kpi, i) => (
 <StatCard
 ...
 <m.section initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-card rounded-[2rem] p-6 md:p-8 pb-4 border border-border shadow-sm">
 <div className="flex items-center justify-between mb-8"><div><h3 className="text-xl font-black">Revenue Waterfall</h3><p className="text-xs text-muted-foreground mt-1">Gross Margin vs Real Opex.</p></div><BarChart3 className="text-muted-foreground"size={28} /></div>
 ...
 <m.section initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="bg-card rounded-[2rem] p-6 md:p-8 border border-border shadow-sm">
 <h3 className="text-xl font-black mb-8 text-foreground">Service Plan Mix</h3>
 <div className="flex flex-col sm:flex-row items-center gap-10">
 <ChartContainer className="h-[220px] w-full sm:w-1/2 relative group shrink-0">
 {isDataLoading ? (
 <div className="w-full h-full bg-muted animate-pulse rounded-[100%]"/>
 ) : (
 ...
 <div key={i} className="h-6 w-full bg-muted animate-pulse rounded-lg"/>
 ))
 ) : (
 ...
 <span className="text-xs font-black text-muted-foreground uppercase tracking-widest group-hover:text-muted-foreground dark:group-hover:text-muted-foreground transition-colors">{item.name}</span>
 </div>
 ...
 <m.section initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 rounded-[2rem] p-6 md:p-8 border border-border/50 dark:border-border/30 shadow-xl relative overflow-hidden">
 <div className="absolute -top-20 -right-20 w-60 h-60 bg-primary/10 rounded-full blur-3xl"/>
 <div className="relative z-10">
 <div className="flex items-center justify-between mb-6"><div><h3 className="text-xl font-black text-foreground mb-1">Profitability Trend</h3><p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Net Profit Month-over-Month</p></div><div className="px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full flex items-center gap-2"><div className="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse"/><span className="text-[10px] font-black text-green-400 uppercase tracking-wider">Live</span></div></div>
 <div className="mb-6">
 ...
 {isDataLoading ? (
 <div className="w-full h-full bg-muted/50 animate-pulse rounded-2xl"/>
 ) : (
