...
export default function InventoryPage() {
  ...
  return (
    <div className="p-4 md:p-8 lg:p-10 max-w-[1600px] mx-auto space-y-6 md:space-y-8 min-h-screen pt-6 lg:pt-8 bg-slate-50 dark:bg-slate-950">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
        <m.div
          ...
          className="space-y-3"
        >
          <h1 className="text-4xl tablet:text-5xl lg:text-6xl font-black text-slate-900 dark:text-white tracking-tight leading-none">
            Asset<br />Management
          </h1>
          <p className="text-sm tablet:text-base font-medium text-slate-500 dark:text-slate-400 max-w-sm tablet:max-w-md leading-relaxed">
